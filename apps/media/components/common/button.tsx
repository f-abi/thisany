...
function HistoryButton({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      >
        {visible ? <IconClockFilled /> : <IconClock />}
      </Button>
      <BrowsingHistory visible={visible} onClick={() => setVisible(false)} />
    </>
  )
}
...
function SearchButton() {
  ...
  return (
    <>
      ...
      <SearchDialog visible={visible} onClick={() => setVisible(false)} />
    </>
  )
}
